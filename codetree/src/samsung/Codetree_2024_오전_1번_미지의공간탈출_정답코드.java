...
public class Codetree_2024_오전_1번_미지의공간탈출_정답코드 {
        ...
        public static void main(String[] args) {
            ...
            // 공간의 상황에 대응되는 그래프 생성
            build_graph(N, M);
            System.out.println("Codetree_2024_오전_1번_미지의공간탈출_정답코드.main");
            for (int i = 0; i < N; i++) {
                for (int j = 0; j < N; j++) {
                    System.out.print(SpaceMapCellId[i][j]+ " ");
                }
                System.out.println();
            }
            System.out.println("Codetree_2024_오전_1번_미지의공간탈출_정답코드.main");
            for (int i = 0; i < 5; i++) {
                for (int j = 0; j < M; j++) {
                    for (int k = 0; k < M; k++) {
                        System.out.print(TimeWallCellId[i][j][k]+ " ");
                    }
                    System.out.println();
                }
            }
